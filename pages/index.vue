...
<script>
  ...
  export default {
    async asyncData() {
      //lets get our boards data before page load, and then after that await changes
    ...
    methods: {
      ...
      createBoard() {
        ...
        if (this.$refs.form.validate()) {
          //Let's give our boards a created date.
          ...
          this.$fire.firestore
            ...
            .then(function(docRef) {
              ...
              that.snackbarText = 'Successfully created your boards'
              that.snackbar = true
            })
            .catch(function(error) {
            })
